...
#     for column in reversed(range(1,indice*2,2)): #Paso ese valor y lo multiplico 6*2 = 1 3 5 7 9 11 (salto de impares)
...
five_number = int(input("Ingrese un numero"))

for indice in range(five_number): #segundo valor en el parentesis
    for two_indice in range(five_number):
        print("|" + str(two_indice) + "-" + str(indice) + "|",end=" ")
    print()
